...
contractAddress = '0x4Ed8Ef1dD93046Eec2d0E508446E5D8b375eF4fa';
...
// ABI
var CoinFlip = new web3.eth.Contract(
    [{"constant": false, "inputs": [], "name": "Play", "outputs": [], "payable": true, "stateMutability": "payable", "type": "function"}, {"constant": false, "inputs": [{"name": "amount", "type": "uint256"}], "name": "withdrawFunds", "outputs": [], "payable": false, "stateMutability": "nonpayable", "type": "function"}, {
        "constant": false,
        ...
        "type": "function"
    }, {"constant": true, "inputs": [{"name": "index", "type": "uint256"}], "name": "getGameEntry", "outputs": [{"name": "addr", "type": "address"}, {"name": "blocknumber", "type": "uint256"}, {"name": "blocktimestamp", "type": "uint256"}, {"name": "bet", "type": "uint256"}, {"name": "prize", "type": "uint256"}, {"name": "winner", "type": "bool"}], "payable": false, "stateMutability": "view", "type": "function"}, {
        "constant": true,
        "inputs": [],
        "name": "MaxAmountToBet",
        ...
        "type": "function"
    }, {"constant": false, "inputs": [], "name": "Kill", "outputs": [], "payable": false, "stateMutability": "nonpayable", "type": "function"}, {"constant": true, "inputs": [{"name": "amount", "type": "uint256"}], "name": "getMaxAmountToBet", "outputs": [{"name": "", "type": "uint256"}], "payable": false, "stateMutability": "view", "type": "function"}, {
        "constant": false,
        "inputs": [{"name": "amount", "type": "uint256"}],
        ...
        "type": "function"
    }, {"constant": true, "inputs": [], "name": "getGameCount", "outputs": [{"name": "", "type": "uint256"}], "payable": false, "stateMutability": "view", "type": "function"}, {"inputs": [], "payable": true, "stateMutability": "payable", "type": "constructor"}, {
        "anonymous": false,
        "inputs": [{"indexed": false, "name": "_msg", "type": "string"}, {"indexed": false, "name": "user", "type": "address"}, {"indexed": false, "name": "amount", "type": "uint256"}, {"indexed": false, "name": "winner", "type": "bool"}],
        "name": "Status",
        "type": "event"
    }],
    contractAddress);
...
$("#submit").click(async function () {
    ...
    if (jQuery.isEmptyObject(accounts[0])) {
    ...
    CoinFlip.methods.Play().send({from: accounts[0], gas: 3000000, value: amount}).then(r => {
        console.log(r)
    })
});
...
function UpdateGamesTable() {
    ...
    CoinFlip.methods.getGameCount().call(function (error, result) {
        if (!error) {
            ...
            for (gameCount--; gameCount >= 0; gameCount--) {
                if (lastPlayedGamesLimit < counter) {
                    break;
                }
